...
If you'd like to start off with a full widget, you can build off of the lastest release of [**Simple Chat**](https://github.com/zaytri/slime2/tree/main/widgets/release-simple-chat).
