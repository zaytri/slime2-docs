...
By utilizing this, you can ensure that the user will see the widget changes in real time, making for a much better user experience. For an example of how to make that work, you can look at it's implementation in [**Slime Chat**](https://github.com/zaytri/slime2/tree/main/widgets/release/slime-chat).
