...
> By returning nothing, slime2 will not render the event. [**Simple Chat**](https://github.com/zaytri/slime2/tree/main/widgets/release-simple-chat) is a great example of how to utilize this to create message filters.
>
...
> [**Simple Chat**](https://github.com/zaytri/slime2/tree/main/widgets/release-simple-chat) is a great example of how to utilize this to create exit animations.
