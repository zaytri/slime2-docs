...
> By returning nothing, slime2 will not render the event. [**Slime Chat**](https://github.com/zaytri/slime2/tree/main/widgets/release/slime-chat) is a great example of how to utilize this to create message filters.
>
...
> [**Slime Chat**](https://github.com/zaytri/slime2/tree/main/widgets/release/slime-chat) is a great example of how to utilize this to create exit animations.
